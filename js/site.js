...
for (var i = 0; i < geoJson.length; i++) {
  ...
  var title, artists, year, country, genres, sources;
...
// filter markers is a general filter for key,value pairs. this is different from years which filters based on greater than/less than constraints. 
...
// first initialize the map with cluster group markers. filtered markers are introduced as plain markers. 
